...
string(JSON c_markdown GET "${c_example_proof}" result formats_produced markdown)
string(JSON cli_markdown GET "${cli_example_proof}" result formats_produced markdown)
if(NOT c_markdown STREQUAL cli_markdown)
  message(FATAL_ERROR "C SDK markdown differs from CLI")
endif()

string(JSON c_links GET "${c_example_proof}" result formats_produced links)
string(JSON cli_links GET "${cli_example_proof}" result formats_produced links)
